...
class SearchVolumeApp(AutomationApp):
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(
            outer,
            text="구글 시트에서 검색량이 비어 있는 키워드만 채웁니다. 0은 이미 채운 값입니다. 띄어쓰기는 자동완성 첫 항목이 같은 글자면 따르고, 다른 단어가 붙으면 무시합니다. 없으면 통합검색 첫 카페 글 제목을 따릅니다. 통합검색 주소도 같이 넣습니다. 값은 이름 상자로 칸을 고른 뒤 수식 입력줄을 눌러 넣습니다. 첫 칸 안을 누르면 붙여넣기 설정 창이 뜨고 비어 남습니다. 그 창이 뜨면 취소합니다. 설치할 필요 없습니다.",
